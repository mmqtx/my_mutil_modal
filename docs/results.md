...
| HiFuse + structure-aware TPA | local method | pending | pending | pending | pending | pending | pending | `/data/ljq24358/mutil_modal_datasets/experiments/ptbxl_hifuse_tpa_structure_aware` |
